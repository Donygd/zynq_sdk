...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../mio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../mio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../mio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../mio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../mio.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
